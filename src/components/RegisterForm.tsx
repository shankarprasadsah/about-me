  ...
  return (
    <div className="h-full flex items-center justify-center p-8">
      <div className="w-full max-w-[280px] text-center">
        <h1 className="text-2xl font-bold text-auth-text mb-8">Create Account</h1>
        ...
        <p className="text-sm text-auth-text-light mb-4">or use your email for registration</p>
